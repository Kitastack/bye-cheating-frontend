...
function DropdownMenuRadioItemWithIcon({
  className,
  customIcon,
  children,
  ...props
  ...
  const RadioIcon = customIcon || CircleIcon
  return (
    <DropdownMenuPrimitive.RadioItem
      data-slot="dropdown-menu-radio-item"
      className={cn(
    ...
    >
      ...
      <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center opacity-40">
